    ...
    <main class="page login-page">
        <section class="clean-block clean-form dark">
            <div class="container">
                ...
                <div class="block-heading"><h2>Свяжитесь с нами</h2></div>
                <form action="contactBD.php" method="POST" style="border-top: 2px solid #AEEABE;">
                    ...
                    <div class="form-group col-md-12">
                        <input type="text" name="subject" class="form-control" required="required" placeholder="Заголовок">
                    </div>
                    <div class="form-group col-md-12">
                        <textarea type="text"  class="form-control" required="required" name="message" placeholder="Введите свое сообщение" rows="5" cols="35"></textarea>
                    </div>


                    <div class="form-group">
                    </div><button class="btn btn-primary btn-block" type="submit" style="background-color: #AEEABE; border-color: white;color: #18201C;">Отправить</button>
                </form>
